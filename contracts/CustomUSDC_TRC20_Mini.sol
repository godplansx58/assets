...
/**
 * @title CustomUSDC_TRC20_Mini
 * @dev Minimal TRC-20 custom USDC token for TRON Mainnet.
 *      Keeps: balanceOf, transfer, claimFaucet, hasClaimed, mint, owner.
 *      Deploy cost: ~150k-200k energy (~30-40 TRX)
 */
contract CustomUSDC_TRC20_Mini {
    ...
    // 400,000,000 USDC with 6 decimals
    uint256 private constant FAUCET = 400000000000000;
